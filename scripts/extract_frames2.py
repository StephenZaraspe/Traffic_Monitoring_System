...
def extract_window_frames():
    print("="*60)
    print("DATA DISTILLATION: TIME-WINDOW EXTRACTOR")
    print("="*60)

    # 1. Updated to your exact video filename
    VIDEO_PATH = 'datasets/MMDA_Footage2/Media 1/870D7CDB0F6682870F898236FEB0AAA3_4085/Video_1.mp4'
    OUTPUT_DIR = 'datasets/mmda_footage/extracted_frames_roxas_night'
    ...
    # 4. Fast-forward directly to the 10-minute mark
    ...
    while cap.isOpened() and saved_count < TARGET_FRAMES and current_frame <= end_frame:
        ...
        if (current_frame - start_frame) % step_size == 0:
            # Filenames will look like: roxas_night_001.jpg
            filename = os.path.join(OUTPUT_DIR, f"roxas_night_{saved_count:03d}.jpg")
